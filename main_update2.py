...
with open(text_dir,'a') as document:
   ...
   # subflder='CyberSecurity'
    try:
        ...
        #if not isExistsub:
        #    os.mkdir(path2)  
        path3 = f'D:\\Infoware\\Cyber_WebScrap_Oct\\May2023\\Kavya_Shared\\CyberSecurityDeployment_May2\\{main_flder}\\policy'
        isExistsub_policy = os.path.exists(path3)
        if not isExistsub_policy:
            os.mkdir(path3)
        path4 = f'D:\\Infoware\\Cyber_WebScrap_Oct\\May2023\\Kavya_Shared\\CyberSecurityDeployment_May2\\{main_flder}\\strategy'
        isExistsub_strategy = os.path.exists(path4)
        if not isExistsub_strategy:
            os.mkdir(path4)
        path5 = f'D:\\Infoware\\Cyber_WebScrap_Oct\\May2023\\Kavya_Shared\\CyberSecurityDeployment_May2\\{main_flder}\\guildlines'
